...
describe("Binary Tree", () => {
    ...
    test('the sum of all odd numer should be equal to 25 ', () => {
      let expected= 25
      expect(tree.findOddSum()).toEqual(expected);
    })
    test('the sum of all odd numer should be equal to 25  using the second method', () => {
      let expected= 25
      expect(tree.findOddSum2()).toEqual(expected);
    })
})